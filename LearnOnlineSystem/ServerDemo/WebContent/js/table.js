$(function(){
    ...
    function add(){
      ...
      $.each(data,function(i, v){
        $("<tr>").attr("index",i).html("<td contenteditable='true' data-role='id'>" + v.id + "</td>" + "<td contenteditable='true' data-role='name'>" + v.name + "</td>" + "<td contenteditable='true' data-role='count'>" + v.count + "</td>"  + "<td><button class='btn btn-danger btn-sm'>删除</button></td><td><button class='btn btn-danger btn-sm'>提交</button></td>" ).insertBefore("tr:last");
      })
      saveData(data);
    }
